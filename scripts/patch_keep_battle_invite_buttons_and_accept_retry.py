...
# Large, two-row invitation: identity + theme, then two 48+ pt actions.
...
# Browse invite has its own timer variable but same layout.
...
# Replace compact styles with smartphone-sized text and controls.
old_styles = """invite: { marginTop: 4, paddingHorizontal: 8, paddingVertical: 7, borderRadius: 14, backgroundColor: '#241730', borderWidth: 1, borderColor: '#E5F266' }, inviteLine: { flexDirection: 'row', alignItems: 'center', gap: 7 }, inviteLabel: { color: '#E5F266', fontSize: 11, fontWeight: '900', marginTop: 2 }, inviteName: { color: '#FFF', fontSize: 13, fontWeight: '900' }, inviteQuestion: { color: '#F3EDF7', fontSize: 12, lineHeight: 16, fontWeight: '800' }, no: { minHeight: 48, minWidth: 76, paddingHorizontal: 10, borderRadius: 16, borderWidth: 1, borderColor: '#746184', alignItems: 'center', justifyContent: 'center' }, noText: { color: '#FFF', fontSize: 11, fontWeight: '900' }, yes: { minHeight: 48, minWidth: 82, paddingHorizontal: 10, borderRadius: 16, backgroundColor: '#E5F266', alignItems: 'center', justifyContent: 'center' }, yesText: { color: '#17130B', fontSize: 11, fontWeight: '900' }, actionDisabled: { opacity: .55 },"""
