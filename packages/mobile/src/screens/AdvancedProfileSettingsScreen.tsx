...
export default function AdvancedProfileSettingsScreen({ navigation }: any) {
  ...
  return (
    <SafeAreaView style={s.container}>
      <View style={s.header}>
        <TouchableOpacity style={s.headerButton} onPress={() => navigation.goBack()} accessibilityLabel="Retour au profil"><Text style={s.headerText}>‹ Retour</Text></TouchableOpacity>
        <Text style={s.title}>Réglages avancés</Text>
        <TouchableOpacity style={s.headerButton} onPress={() => navigation.navigate('Main', { screen: 'MyMusic' })} accessibilityLabel="Revenir aux Playlists"><Text style={[s.headerText, s.right]}>Playlists</Text></TouchableOpacity>
      </View>
      ...
      <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={s.backPlaylists} onPress={() => navigation.navigate('Main', { screen: 'MyMusic' })}><Text style={s.backPlaylistsText}>← Revenir aux Playlists</Text></TouchableOpacity>
      </ScrollView>
    </SafeAreaView>
  );
}
