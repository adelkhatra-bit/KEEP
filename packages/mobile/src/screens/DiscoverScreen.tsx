...
const styles = StyleSheet.create({
  ...
  discoveryHeader:{flexDirection:'row',alignItems:'center',gap:7,marginBottom:5},usernameSearch:{minHeight:46,flexDirection:'row',alignItems:'center',gap:8,paddingHorizontal:12,marginBottom:7,borderRadius:16,backgroundColor:colors.backgroundElevated,borderWidth:1,borderColor:colors.border},usernameSearchIcon:{color:colors.primaryLight,fontSize:20,fontWeight:'800'},usernameSearchInput:{flex:1,minHeight:44,color:colors.white,fontSize:15,fontWeight:'700'},usernameClear:{width:36,height:36,borderRadius:18,alignItems:'center',justifyContent:'center',backgroundColor:colors.backgroundCard},usernameClearText:{color:colors.white,fontSize:22,lineHeight:24,fontWeight:'700'},
