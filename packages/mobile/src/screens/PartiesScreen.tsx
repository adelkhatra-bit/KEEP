...
export default function PartiesScreen({ navigation }: any) {
  ...
  return <SafeAreaView style={styles.container}>
    <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
      ...
      <TouchableOpacity style={[styles.battleLauncher,battleOpen&&styles.battleLauncherOpenState]} onPress={() => setBattleOpen((value) => !value)} accessibilityRole="button" accessibilityLabel={battleOpen ? 'Fermer le Salon KEEP Battle' : 'Ouvrir le Salon KEEP Battle'}>
        ...
        <View style={styles.battleLauncherCopy}>
          ...
          <Text style={styles.battleLauncherMeta}>Solo ou multijoueur · aucun code à écrire · aucun swipe obligatoire</Text>
        </View>
        <Text style={styles.battleLauncherOpen}>{battleOpen ? 'FERMER ↑' : 'OUVRIR ↓'}</Text>
      </TouchableOpacity>

      {battleOpen ? <View style={styles.inlineBattle}>
