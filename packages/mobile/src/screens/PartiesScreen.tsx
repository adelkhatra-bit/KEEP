...
export default function PartiesScreen({ navigation }: any) {
  ...
  return <SafeAreaView style={styles.container}>
    <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
      {battleOpen ? <>
        <View style={styles.battleModeHeader}>
          <View style={{flex:1}}><Text style={styles.battleModeKicker}>KEEP BATTLE</Text><Text style={styles.battleModeTitle}>Mode jeu</Text><Text style={styles.battleModeMeta}>Écran dédié · aucun SwipeDeck de Soirées pendant la partie</Text></View>
          <TouchableOpacity style={styles.battleExit} onPress={() => setBattleOpen(false)} accessibilityRole="button" accessibilityLabel="Retour aux soirées"><Text style={styles.battleExitText}>RETOUR</Text></TouchableOpacity>
        </View>
        ...
        <TouchableOpacity style={styles.battleLauncher} onPress={() => setBattleOpen(true)} accessibilityRole="button" accessibilityLabel="Ouvrir le Salon KEEP Battle">
          ...
          <View style={styles.battleLauncherCopy}>
            ...
            <Text style={styles.battleLauncherMeta}>Ouvre un mode jeu dédié · solo ou multijoueur · aucun code à écrire</Text>
          </View>
