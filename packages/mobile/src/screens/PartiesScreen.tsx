...
export default function PartiesScreen({ navigation }: any) {
  ...
  return <SafeAreaView style={styles.container}>
    <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      {currentEvent ? <>
        <SwipeDeck resetKey={currentEvent.id} enabled={busyId!==currentEvent.id} onSwipeLeft={()=>chooseRsvp(currentEvent.id,'NOT_GOING',true)} onSwipeRight={()=>chooseRsvp(currentEvent.id,'GOING',true)} leftLabel="NON" rightLabel="J’Y VAIS" hint="Glisse ← non · → je participe · boutons disponibles">
    ...
    <Modal visible={battleOpen} transparent animationType="slide" onRequestClose={() => setBattleOpen(false)}>
