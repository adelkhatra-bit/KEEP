...
export default function PartiesScreen({ navigation, route }: any) {
  ...
  const publish = async (notifyFollowers: boolean) => {
    ...
    try {
      ...
      setCreateOpen(false); setName(''); setStartsAt(''); setVenueName(''); setVenueCoords(null); setVenueSuggestions([]); setYoutubeUrl(''); setDescription(''); setMessage('');
      await reload();
