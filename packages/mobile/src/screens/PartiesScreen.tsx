...
import { loadKeepBattleGlobalLeaderboard, loadKeepBattleThemes, KeepBattleGlobalLeaderboardEntry } from '../services/keepBattleService';
            ...
            <View style={styles.leaderboardPanel}>
              ...
              {leaderboard.map((entry, index) => (
                <TouchableOpacity
                  ...
                  onPress={() => navigation.navigate('PublicUserProfile', { username: entry.username })}
                >
