    ...
    Alert.alert(
      ...
      [
        ...
        { text: 'Supprimer', style: 'destructive', onPress: async () => {
          ...
          catch { Alert.alert('Soirée', 'Impossible de supprimer cette soirée pour le moment.'); }
  ...
  const publish = async () => {
    ...
    try {
      ...
      if (editingEventId) {
        ...
        resetEventForm();
        await reload();
        Alert.alert('Soirée modifiée', 'Les changements sont enregistrés.');
      } else {
        ...
        resetEventForm();
        await reload();
        Alert.alert('Soirée publiée', `${sent} abonné(s) ont reçu l’invitation Loki.`);
      }
    } catch (e: any) {
      ...
      else Alert.alert('Soirée', code || 'Impossible d’enregistrer la soirée pour le moment.');
