    ...
    <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
      ...
      <View style={s.hero}>
        ...
        {battleFeatureEnabled && !accountRequired && battleAvailabilityInfoOpen ? (
          <Text style={s.battleAvailabilityHint}>Active "Disponible" pour recevoir des invitations Battle, même ailleurs dans Loki, sans jouer en solo. Désactive-la quand tu ne veux plus être dérangé.</Text>
        ) : null}
...
battleAvailabilityRow:{flexDirection:'row',alignItems:'center',justifyContent:'space-between',gap:8,marginTop:10,paddingVertical:6,paddingHorizontal:10,borderRadius:12,backgroundColor:'#18121F',borderWidth:1,borderColor:'#31263B'},battleAvailabilityRowOn:{backgroundColor:'#12271C',borderColor:'#38D990'},battleAvailabilityMain:{flexDirection:'row',alignItems:'center',gap:6,flex:1},battleAvailabilityDot:{fontSize:12},battleAvailabilityTitle:{color:'#FFF',fontSize:12,fontWeight:'900'},battleAvailabilityInfoIcon:{color:'#B79CFF',fontSize:14,fontWeight:'900'},battleAvailabilityHint:{color:'#FFFFFF',fontSize:11,lineHeight:15,marginTop:5,paddingHorizontal:2},
