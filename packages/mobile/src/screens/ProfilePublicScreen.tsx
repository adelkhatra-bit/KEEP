        ...
        <View style={s.trackMetaRow}>
          ...
          {sourceUsername !== undefined ? sourceUsername ? (
            <View style={s.originInline}>
              ...
              <TouchableOpacity style={s.originUserButton} onPress={() => openSourceProfile(sourceUsername)} accessibilityLabel={`Ouvrir le profil de ${sourceUsername}`}>
                <Text style={s.originUserText}>@{sourceUsername.slice(0, 5)}</Text>
              </TouchableOpacity>
            </View>
          ) : <Text style={s.keepOriginFree}>FREE</Text> : null}
        </View>
      </View>
    </View>
  );
