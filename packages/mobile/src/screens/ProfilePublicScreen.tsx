...
export default function ProfilePublicScreen({ navigation }: any) {
  ...
  useEffect(() => { let live = true; isFeatureEnabled('playlist_marketplace').then((enabled) => live && setMarketplaceEnabled(enabled)); return () => { live = false; }; }, []);
