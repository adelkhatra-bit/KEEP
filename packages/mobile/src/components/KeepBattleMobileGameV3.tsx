            ...
            {statsLoading ? <ActivityIndicator color="#E5F266" /> : statsData ? (
              <>
                <View style={s.statsBigRow}>
                  <View style={s.statsBigItem}><Text style={s.statsBigValue}>{statsData.wins}</Text><Text style={s.statsBigLabel}>Victoires</Text></View>
                  <View style={s.statsBigItem}><Text style={s.statsBigValue}>{statsData.matchesPlayed}</Text><Text style={s.statsBigLabel}>Matchs</Text></View>
                  <View style={s.statsBigItem}><Text style={s.statsBigValue}>{statsData.totalCorrect}</Text><Text style={s.statsBigLabel}>Bonnes rép.</Text></View>
                </View>
  ...
  const openPlayerOptions = (player: KeepBattleLivePlayer) => {
    Alert.alert(
      ...
      [
        ...
        { text: 'Voir le palmarès', onPress: () => openPlayerStats(player) },
