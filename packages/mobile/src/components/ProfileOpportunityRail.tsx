...
const s=StyleSheet.create({
  ...
  foot:{color:colors.textMuted,fontSize:8,fontWeight:'800',marginTop:8},saleActions:{flexDirection:'row',alignItems:'center',justifyContent:'space-between',gap:7,marginTop:8},saleBadge:{flex:1,minWidth:0,paddingHorizontal:8,paddingVertical:6,borderRadius:10,borderWidth:1,borderColor:colors.primary},saleBadgeText:{color:colors.primaryLight,fontSize:8,fontWeight:'900'},listenButton:{paddingHorizontal:10,paddingVertical:7,borderRadius:11,backgroundColor:colors.primary},listenButtonText:{color:'#fff',fontSize:9,fontWeight:'900'},
