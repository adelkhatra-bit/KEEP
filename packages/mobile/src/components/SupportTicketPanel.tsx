...
const s = StyleSheet.create({
  ...
  send: { minHeight: 42, marginTop: 10, borderRadius: 21, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.primary }, sendText: { color: colors.white, fontSize: 14, fontWeight: '900' },
  ...
  ticket: { minHeight: 54, marginTop: 7, borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, paddingHorizontal: 11, paddingVertical: 9, flexDirection: 'row', alignItems: 'center', gap: 8 }, ticketActive: { borderColor: colors.primaryLight }, ticketText: { flex: 1 }, ticketSubject: { color: colors.textPrimary, fontSize: 14, fontWeight: '900' }, ticketMeta: { color: colors.textMuted, fontSize: 15, marginTop: 3 }, status: { color: colors.primaryLight, fontSize: 15, fontWeight: '900' },
  thread: { marginTop: 13, paddingTop: 13, borderTopWidth: 1, borderTopColor: colors.border }, threadTitle: { color: colors.textPrimary, fontSize: 15, fontWeight: '900', marginBottom: 8 }, bubble: { padding: 10, borderRadius: radius.md, marginTop: 7, maxWidth: '94%' }, adminBubble: { backgroundColor: colors.backgroundElevated, alignSelf: 'flex-start', borderWidth: 1, borderColor: colors.primaryLight }, userBubble: { backgroundColor: colors.background, alignSelf: 'flex-end', borderWidth: 1, borderColor: colors.border }, bubbleAuthor: { color: colors.primaryLight, fontSize: 15, fontWeight: '900', marginBottom: 4 }, bubbleText: { color: colors.textPrimary, fontSize: 14, lineHeight: 16 },
  replyInput: { minHeight: 68, textAlignVertical: 'top' }, replyButton: { minHeight: 38, marginTop: 8, borderRadius: 19, borderWidth: 1, borderColor: colors.primaryLight, alignItems: 'center', justifyContent: 'center' }, replyText: { color: colors.primaryLight, fontSize: 14, fontWeight: '900' },
});
