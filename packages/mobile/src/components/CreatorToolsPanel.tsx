...
export default function CreatorToolsPanel({ navigation }: any) {
  ...
  return <View style={s.card}>
    ...
    {user.kind !== 'USER' ? <TouchableOpacity style={s.standardProfileLink} onPress={() => changeKind('USER')} disabled={busy} accessibilityLabel="Revenir au profil utilisateur">
      <Text style={s.standardProfileLinkText}>Revenir au profil utilisateur</Text>
