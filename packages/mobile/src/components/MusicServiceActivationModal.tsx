        ...
        <View style={s.card} accessibilityViewIsModal>
          ...
          <View style={s.hero}>
            ...
            <View style={s.heroText}>
              ...
              <Text style={s.subtitle}>Tu gardes le contrôle. KEEP mémorise uniquement que tu veux utiliser ce service.</Text>
            </View>
          </View>
          ...
          <View style={s.infoBox}>
            ...
            <Step n="3" text={`Quand tu envoies un morceau ou une Vibe vers ${name}, KEEP prépare la musique puis ouvre le service choisi.`} />
          </View>

          <View style={s.safeBox}>
            <Text style={s.safeTitle}>✓ Tes accès restent privés</Text>
            <Text style={s.safeText}>KEEP ne demande pas ton mot de passe {name}, ne lit pas ta bibliothèque privée et ne publie rien à ta place. Sans API du fournisseur, KEEP utilise simplement le passage sécurisé vers l’application ou le site du service.</Text>
          </View>
...
const s = StyleSheet.create({
  ...
  subtitle: { color: '#E2DAEA', fontSize: 10, lineHeight: 15, marginTop: 4 },
  ...
  stepText: { flex: 1, color: '#FFFFFF', fontSize: 10, lineHeight: 15 },
  ...
  confirmText: { color: '#FFFFFF', fontSize: 9, fontWeight: '900', textAlign: 'center' },
});
