...
const s = StyleSheet.create({
  ...
  errorBox: { borderRadius: radius.lg, backgroundColor: 'rgba(255,92,114,0.12)', borderWidth: 1, borderColor: colors.pass, padding: spacing.lg, alignItems: 'center' },
  ...
  accessCardUnlocked: { borderColor: colors.success, backgroundColor: 'rgba(45,225,194,0.08)' },
