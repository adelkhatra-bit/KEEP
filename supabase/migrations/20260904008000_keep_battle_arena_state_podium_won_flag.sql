-- Adel (04/09/2026) : suite du fix "podium a 2 places" -- keep_battle_arena_
-- finish_match credite desormais le 2e place, mais keep_battle_arena_state
-- calculait encore "won" comme placement=1 uniquement : le 2e aurait vu sa
-- ligne classee "perdant" (rouge) et lastResult.won=false malgre un
-- creditDelta positif reel. "won" suit maintenant le vrai credit gagne
-- (montant > 0 dans keep_battle_arena_credit_events), coherent avec
-- l'argent affiche.
