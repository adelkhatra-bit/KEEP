-- Adel (03/09/2026) : troisième occurrence du même trou (round_count plafonné
-- à 12 quelque part alors que le choix va jusqu'à 30) -- cette fois dans
-- keep_battle_solo_pack lui-même : son clamp interne
-- (greatest(5,least(p_round_count,12))) ramenait silencieusement tout choix
-- de 15/20/30 à 12 côté solo, sans erreur, juste moins de manches que
-- demandé. Même correctif que pour les arènes (migrations précédentes),
-- plafond remonté à 30.
