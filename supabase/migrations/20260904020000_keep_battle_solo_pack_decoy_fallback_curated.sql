-- Adel (04/09/2026) : meme bug que keep_battle_arena_seed_rounds (voir
-- 20260904019000), version Battle SOLO : le filet de secours des fausses
-- reponses piochait dans TOUTE la table tracks sans filtre theme des que le
-- theme choisi manquait d'autres artistes tagues -- restreint desormais au
-- catalogue Battle cure (n'importe quel theme dans keep_battle_track_themes)
-- au lieu de la table tracks entiere.
