-- Adel (02/09/2026) : "quand j'appuie sur revanche ça envoie pas une
-- invitation à l'autre utilisateur pour lui dire il souhaite prendre sa
-- revanche" -- proposer une revanche ne notifiait jamais les autres joueurs,
-- seul un bandeau passif apparaissait s'ils étaient déjà, par hasard, sur le
-- même écran. Ajoute une vraie notification à chaque autre membre actif.
