-- Adel (04/09/2026) : suite de keep_battle_arena_multi_theme_mix -- expose
-- theme_codes (l'UNION réelle des styles mixés) dans keep_battle_arena_state
-- pour un futur affichage côté client, sans rien changer d'autre à cette
-- fonction.
