...
begin
 ...
 -- Group invitation: join the exact same waiting arena. Never fork the group.
 ...
 -- Direct 1v1 invitation: create one arena, add both players, then start on the server.
