...
as $$
  ...
  offers as (
    select o.id offer_id, o.seller_id, p.username seller_username, p.avatar_url seller_avatar_url,
      o.playlist_name, count(ot.track_id)::integer track_count,
      ...
      count(distinct vg.genre)::integer match_score,
      o.updated_at
    ...
    group by o.id,p.username,p.avatar_url,o.playlist_name,o.payment_mode,o.price_cents,o.free_price,o.currency_code,o.updated_at
  )
