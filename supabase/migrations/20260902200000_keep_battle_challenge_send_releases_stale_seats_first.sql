-- Complément de 20260902190000 : appeler le nettoyage de sièges fantômes
-- aussi au moment d'ENVOYER une invite (pas seulement en lisant l'état d'une
-- arène déjà ouverte), pour les deux comptes concernés (challenger et
-- cible). Sans ça, un utilisateur qui n'a jamais rouvert son ancienne arène
-- abandonnée reste bloqué même si l'AUTRE lui envoie une invite en premier.
